...
save_model_dir = 'save_file_dir/pytorch_sdrcnn_cocoeval2'
...
def main():
    ...
    dataset = SdMaskDataSet('datasets/low-res', get_transform(train=True))
    dataset_test = SdMaskDataSet('datasets/low-res', get_transform(train=False))
